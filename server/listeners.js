...
module.exports = (app, express) => {
  ...
  io.on('connection', (socket) => {
    ...
    // UPDATE ALARM TIME
    socket.on('update-alarm-time', (newAlarmTime) => { // NOT IN USE
      updateAlarm(null, null, {
        alarmclock: true,
        data: newAlarmTime,
        table: 'alarmtime',
        column: ['hour', 'minute', 'tod'],
    ...
    app.get('/get-skipped-data/', (req, res) => getData(req, res, {
      alarmclock: false,
      table: 'skippedcount',
      column: ['skipped', 'skipdate'],
    }));
    ...
    app.patch('/update-skipped-count', (req, res) => {
      updateSkippedCount(req, res, {
        alarmclock: false,
        data: req.body.data,
        table: 'skippedcount',
        column: ['skipped', 'skipdate'],
